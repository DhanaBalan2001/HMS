...
const AdminDoctors = () => {
  ...
  const handleApprove = async (doctorId) => {
    try {
      ...
      setToast({ message: 'Doctor approved! Email notification sent.', type: 'success' });
    } catch (error) {
      setToast({ message: 'Failed to approve doctor', type: 'error' });
    }
  };
  ...
  const handleReject = async (doctorId) => {
    try {
      ...
      setToast({ message: 'Doctor removed from system.', type: 'error' });
    } catch (error) {
